...
class ShopComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.shop-component',['product_attribute'=>$AttributeValue,'brands'=>$brands,'new_product_banner'=>$new_product_banner,'products' => $products,'categories'=> $categories,'sale' => $sale,'popular_products'=>$popular_products])->layout("layouts.base");
    }
}
