...
class ShopComponent extends Component
{
    ...
    public function render()
    {
        ...
        $Cproduct_attribute = ProductAttribute::where('name','=','Color')->join('attribute_values','attribute_values.product_attribute_id','=','product_attributes.id')->GroupBy('attribute_values.product_attribute_id')->get();
