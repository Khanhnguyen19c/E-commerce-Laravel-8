...
class HomeComponent extends Component
{
    public function render()
    {
        ...
        return view('livewire.home-component',['product_banner'=>$product_banner,'new_product_banner'=>$new_product_banner,'banners'=>$banners,'sliders'=>$sliders,'lproducts'=>$lproducts,'categories'=>$categories,'no_of_products'=>$no_of_products,'sale_products'=>$sale_products,'sale'=>$sale])->exte('layouts.base');
    }
}
