...
class ShopComponent extends Component
{
    ...
    public function render()
    {
        ...
        $Cproduct_attribute = ProductAttribute::where('name','Color')->with(['attributeValues'=>function($query){
            $query->selectRaw('*,count(value) as total')->groupBy('currency_list');)->groupBy('value')->get();
