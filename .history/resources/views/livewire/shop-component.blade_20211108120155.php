					...
					<div class="widget mercado-widget filter-widget">
						...
						<div class="widget-content">
							<ul class="list-style vertical-list has-count-index">
								@foreach ($Cproduct_attribute as $attribute)
                                <li class="list-item"><a class="filter-link " href="#">{{ $attribute->value }} </a></li>
                                @endforeach
					...
					<div class="widget mercado-widget filter-widget">
						...
						<div class="widget-content">
							<ul class="list-style inline-round ">
								@foreach ($Sproduct_attribute as $Sproduct_attribute)
