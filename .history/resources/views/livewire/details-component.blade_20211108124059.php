            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <a href="https://twitter.com/KShopper?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="false">Follow @KShopper</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                        </div>
                        ...
                        <div>
                            @foreach ($product->attributevalues->unique('product_attribute_id') as $av)
                                ...
                                <div class="col-xs-2">
                                    ...
                                    <div class="col-xs-10">
                                        <select class="list-style inline-round" style="width:  200px;" wire:model="satt.{{$av->productAttribute->name}}">
