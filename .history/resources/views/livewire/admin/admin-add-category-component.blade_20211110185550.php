    ...
    <div class="panel-body">
        ...
        <form action="POST" class="form-horizontal" wire:submit.prevent="storeCategory">
            <div class="form-group">
                <label class="col-md-6 control-label">Tên Danh Mục</label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="col-md-6 control-label">Slug Danh Mục</label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="col-md-6 control-label">Danh Mục Cha</label>
                <div class="col-md-6">
