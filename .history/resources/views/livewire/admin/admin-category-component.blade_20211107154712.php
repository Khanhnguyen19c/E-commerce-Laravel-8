                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <button type="button" data-target="#modal-formEdit" wire:key="{{('category_slug'=>$category->slug]}}" data-toggle="modal" class="btn btn-success pull-right"><i class="fa fa-edit fa-2x"></i> </button>
