                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <button type="button" class="btn btn-success pull-right" wire:click.prevent="editbrand({{$brand->id}})"><i class="fa fa-edit fa-2x"></i></button>
...
<div class="modal" id="formEdit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style=" text-align: center;font-size: 18px;color: white;background-color: #7373ff;">
        <h5 class="modal-title" style="font-size:17px;font-weight:bold;">Cập nhật thương hiệu mới</h5>
      </div>
      <div class="modal-body">
