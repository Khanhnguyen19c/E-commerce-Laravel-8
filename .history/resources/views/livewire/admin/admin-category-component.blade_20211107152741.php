            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button type="button" data-target="#modal-formAdd" data-toggle="modal" class="btn btn-success pull-right">Thêm danh mục</button>
                        </div>
                    </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" wire:click.prevent="refesh" data-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal" id="modal-formEdit" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style=" text-align: center;font-size: 18px;color: white;background-color: #7373ff;">
        <h5 class="modal-title" style="font-size:17px;font-weight:bold;">Cập nhật danh mục mới</h5>
      </div>
      <div class="modal-body">
      @livewire('admin.admin-add-category-component')
      </div>
