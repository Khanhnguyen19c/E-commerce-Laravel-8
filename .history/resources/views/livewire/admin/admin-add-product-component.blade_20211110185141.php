            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form action="POST" id="form" class="form-horizontal" wire:submit.prevent="addProduct">
                            ...
                            <div class="form-group" wire:ignore>
                                ...
                                <div class="col-md-4">
                                    <input id="amount" type="number" value="1" placeholder="giá sản phẩm" class="form-control input-md" wire:model="regular_price">
