                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <button type="button" data-target="#modal-formEdit" data-toggle="modal" class="btn btn-success pull-right" wire:model="editbrand()"><i class="fa fa-edit fa-2x"></i></button>
