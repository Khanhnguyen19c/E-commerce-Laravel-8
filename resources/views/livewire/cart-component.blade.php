			...
			<div class=" main-content-area">
				<div class="wrap-iten-in-cart">
					...
					<ul class="products-cart">
						...
						<li class="pr-cart-item">
							...
							<div class="price-field produtc-price"><p class="price">{{ number_format($item->model->sale_price,0,',',',') }} đ</p></div>
                            @else
                            <div class="price-field produtc-price"><p class="price">{{ number_format($item->model->regular_price,0,',',',') }} đ</p></div>
                            @endif
							<div class="quantity">
							...
							<div class="price-field sub-total"><p class="price">{{ number_format($item->subtotal,0,',',',') }} đ</p></div>
							<div class="delete">
				...
				<div class="summary">
					<div class="order-summary">
						...
						<p class="summary-info"><span class="title">Thành Tiền: </span><b class="index">{{ Cart::subtotal(0, ',','.').' Đ'}} </b></p>
                        <p class="summary-info"><span class="title">Thuế: </span><b class="index">{{ Cart::tax(0, ',','.').' Đ'}} Đ</b></p>
						<p class="summary-info"><span class="title">Phí Ship</span><b class="index">Free Shipping</b></p>
						<p class="summary-info total-info "><span class="title">Tổng cộng: </span><b class="index">{{ Cart::total(0, ',','.').' Đ'}} </b></p>
					</div>
					<div class="checkout-info">
						<label class="checkbox-field">
							<input class="frm-input " name="have-code" id="have-code" value="" type="checkbox"><span>Tôi có mã khuyến mãi</span>
						</label>
