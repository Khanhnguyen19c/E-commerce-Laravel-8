            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form action="POST" class="form-horizontal" wire:submit.prevent="updatePost">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="hidden" value="{{Auth::user()->name}}" class="form-control input-md" disabled wire:model="author">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @else
                                             <img src="{{asset('assets/images/posts') }}/{{$image}}" width="120">
                                    @endif
                                </div>
                            </div>
