        ...
        <div class="row">
            <div class="col-md-12">
                <div id="review_form_wrapper">
                    <div id="comments">
                        <h2 class="woocommerce-Reviews-title">Thêm đánh giá mới</h2>
                                ...
                                <div id="comment-20" class="comment_container">
                                    ...
                                    <div class="comment-text">
                                        ...
                                        <div class="description">
                                            <p>{{  $orderItem->product->short_desc  }}</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                        ...
                        <div id="respond" class="comment-respond">
                            ...
                            <form wire:submit.prevent="addReview" action="#" method="post" id="commentform" class="comment-form" novalidate="">
                                ...
                                <p class="comment-form-author">
                                    <label for="author">Viết đánh giá của bạn <span class="required">*</span></label>
