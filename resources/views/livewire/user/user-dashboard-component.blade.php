        ...
        <div class="row">
                ...
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            <span class="icon-stat-label">Tổng chi phí </span>
                            <span class="icon-stat-value">{{number_format($totalCost,0,',',',')}}đ</span>
                        </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            <span class="icon-stat-label">Tổng số đơn hàng</span>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            <span class="icon-stat-label">Số đơn hàng đã giao</span>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="icon-stat">
                    <div class="row">
                        <div class="col-xs-8 text-left">
                            <span class="icon-stat-label">Số đơn hàng đã huỷ</span>
