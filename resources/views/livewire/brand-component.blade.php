    ...
    <div class="container">
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>{{$brand->name}}</span></li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="widget mercado-widget filter-widget brand-widget">
                    ...
                    <div class="widget-content">
                        <ul class="list-style vertical-list list-limited" data-show="6">
                            ...
                            <li class="list-item default-hiden"><a class="filter-link" href="{{ route('product.brand',['brand_slug'=>$item->slug]) }}"><input type="checkbox" class="" {{  ($item->id == $brand->id) ? 'checked' :' '}}> {{$item->name}}</a></li>
                            @php
                            $i = 'show'
                            @endphp
                            @else
                            <li class="list-item"><a class="filter-link" href="{{ route('product.brand',['brand_slug'=>$item->slug]) }}"><input type="checkbox" class=""  {{  ($item->id == $brand->id) ? 'checked' :' '}}> {{$item->name}}</a></li>
                            @endif
                            @endforeach
                            @if ($i == 'show')
